...
// Microsoft-inspired color scheme for CommuniCare
const theme = {
  colors: {
...
export const LoginForm: React.FC = () => {
  ...
  const featureImageUrls = {
    multimedia:
      "https://placehold.co/600x400/107C10/FFFFFF?text=Multimedia+Menus",
    translate: "https://placehold.co/600x400/0078D4/FFFFFF?text=AI+Translation",
    analytics:
      "https://placehold.co/600x400/50E6FF/333333?text=Restaurant+Analytics",
  };
        ...
        >
          ...
          >
            ...
            <Box sx={{ position: "relative", zIndex: 1 }}>
              ...
              >
                CommuniCare reimagines traditional menus with engaging
                multimedia content. Powered by Azure AI, we help restaurants
              ...
              <Stack spacing={3}>
                ...
                >
                  ...
                  <Box>
                    ...
                    <Typography variant="body2">
                      Showcase preparation videos, chef introductions, and
                      ingredient stories that bring your dishes to life
                    </Typography>
                  </Box>
                </Box>
                ...
                >
                  ...
                  <Box>
                    ...
                    <Typography variant="body2">
                      Break language barriers with automatic menu translation to
                      serve international customers with confidence
                    </Typography>
                  </Box>
                </Box>
                ...
                >
                  ...
                  <Box>
                    ...
                    <Typography variant="body2">
                      Collect meaningful feedback and analyze customer
                      preferences to optimize your menu and boost satisfaction
                    </Typography>
                  </Box>
                </Box>
              </Stack>
