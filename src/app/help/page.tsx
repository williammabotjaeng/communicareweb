...
const AZURE_BOT_FUNCTION_URL =
  "https://your-function-app.azurewebsites.net/api/BotFunction";
...
const supportOptions = [
  {
    ...
    action: "Email Us",
    actionLink: "mailto:support@CommuniCare.com",
  },
  {
  ...
  },
  {
    ...
    description: "Connect with other CommuniCare users",
...
const AzureBotChat: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "👋 Hi there! I'm MenuAssist, your CommuniCare help bot. How can I assist you today? You can ask me questions about creating menus, QR codes, translations, and more!",
      sender: "bot",
      timestamp: new Date(),
    },
  ]);
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      >
        ...
        >
          This chat is powered by Azure AI. Your conversations help us improve
          our support.
        </Typography>
      </Box>
    </Box>
    ...
    >
      ...
      >
        <Container maxWidth="md">
          ...
          >
            Find answers to all your questions about CommuniCare
          </Typography>
          ...
          {hasSearched && (
            <Paper
              sx={{ mt: 2, p: 2, maxWidth: 600, mx: "auto", textAlign: "left" }}
            >
      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        <Box sx={{ mb: 6 }}>
          <Typography
            variant="h4"
            component="h2"
            sx={{ fontWeight: 700, mb: 4, color: theme.colors.text }}
          >
                ...
                <Link href={category.link} style={{ textDecoration: "none" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography
                        variant="body2"
                        sx={{ color: theme.colors.lightText, mb: 2 }}
                      >
        ...
        <Box sx={{ width: "100%" }}>
              ...
              {supportOptions.map((option, index) => (
                <Grid xs={12} sm={6} md={3} key={index}>
                  ...
                  >
                    ...
                    <Typography
                      variant="body2"
                      sx={{ color: theme.colors.lightText, mb: 3 }}
                    >
                      {option.description}
                    </Typography>
            ...
            <Grid container spacing={3}>
              <Grid xs={12} md={8}>
                <Paper elevation={1} sx={{ p: 3 }}>
                  ...
                  <Typography variant="body1" paragraph>
                    As a restaurant owner, CommuniCare gives you powerful tools
                    to showcase your offerings and enhance the dining experience
                    for your customers. Here are some resources to help you
              ...
              <Grid xs={12} md={4}>
                <Paper elevation={1} sx={{ p: 3, height: "100%" }}>
                  ...
                  <Typography variant="body1" paragraph>
                    Schedule a 30-minute consultation with our restaurant
                    success team to get personalized guidance for your business.
                  </Typography>
          ...
          <TabPanel value={tabValue} index={3}>
            ...
            <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
              ...
              <Typography variant="body1" paragraph>
                Digital menus enhance your dining experience by providing rich
                visuals, detailed information, and easy navigation. Here's how
              ...
              <Grid container spacing={3}>
                <Grid xs={12} md={4}>
                  <Box>
                    ...
                    <Typography variant="body2" paragraph>
                      Simply open your phone's camera and point it at the QR
                      code on your table. Tap the notification that appears to
                      open the digital menu instantly.
                    </Typography>
                  </Box>
                </Grid>
                ...
                <Grid xs={12} md={4}>
                  <Box>
                    ...
                    <Typography variant="body2" paragraph>
                      Look for play buttons on menu items to watch videos of
                      dishes being prepared or presentation highlights. Tap
                ...
                <Grid xs={12} md={4}>
                  <Box>
                    ...
                    <Typography variant="body2" paragraph>
                      Look for a language selector icon, usually at the top of
                      the menu. Select your preferred language to translate the
              ...
              <List>
                <ListItem>
                  ...
                  <ListItemText
                    ...
                    secondary="No, CommuniCare works directly in your phone's web browser without needing any app installation."
                  />
                </ListItem>
                <ListItem>
                  <ListItemIcon>
                  ...
                  <ListItemText
                    ...
                    secondary="Yes, CommuniCare doesn't collect any personal information from diners who view menus."
                  />
                </ListItem>
                <ListItem>
                  <ListItemIcon>
      ...
      >
        ...
        >
          ...
          <Button onClick={toggleChatDrawer} sx={{ minWidth: "auto", p: 1 }}>
            <Close />
          </Button>
        </Box>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={3}>
            ...
            <Grid xs={12} md={4}>
              ...
              >
                <Mail fontSize="small" sx={{ mr: 1 }} /> support@CommuniCare.com
              </Typography>
              <Typography
                variant="body2"
                sx={{
          ...
          >
            <Typography variant="body2" sx={{ color: "rgba(255,255,255,0.5)" }}>
              © {new Date().getFullYear()} CommuniCare. All rights reserved.
            </Typography>
