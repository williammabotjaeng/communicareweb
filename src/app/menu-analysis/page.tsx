    ...
    if (menuAnalysisError) {
      setSnackbar({
        ...
        message: `Error analyzing menu: ${
          menuAnalysisError.response?.data?.error || menuAnalysisError.message
        }`,
        severity: "error",
      });
    }
          ...
          <Grid item xs={12} md={6}>
            <Paper elevation={3} sx={{ p: 3, height: "100%" }}>
              ...
              <Typography variant="h5" sx={{ mb: 2 }}>
                {analysisResults.dish_name ||
                  analysis.dish_analyzed ||
                  "Unnamed Dish"}
              </Typography>
              ...
              <Box>
                <Typography
                  ...
                  sx={{
                    mb: 1,
                    fontWeight: "bold",
                    color: analysis.health_warnings ? "#d32f2f" : "#107C10",
                  }}
                >
                  <Warning
                    sx={{
                ...
                <Typography variant="body2" sx={{ mb: 2 }}>
                  {analysis.health_warnings ||
                    "No specific health warnings for this dish."}
                </Typography>
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" sx={{ mb: 4 }}>
            ...
            ingredients analysis, and dietary advice.
          </Typography>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={6}>
                <Typography variant="body1" sx={{ mb: 2 }}>
                  Our AI can analyze food images to identify ingredients,
                  estimate nutritional content, and provide dietary advice.
                  Simply upload a clear image of a dish to get started.
                </Typography>
          ...
          {isMenuAnalysisLoading && (
            <Box sx={{ display: "flex", justifyContent: "center", my: 4 }}>
              <Box sx={{ textAlign: "center" }}>
                ...
                <Typography variant="h6">Analyzing menu item...</Typography>
                <Typography variant="body2" color="text.secondary">
