          ...
          >
            ...
            <Box sx={{ mb: 5 }}>
              <Typography variant="body1" paragraph>
                At CommuniCare, we take your privacy seriously. This Privacy
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                <AccordionDetails>
                  ...
                  >
                    Note: CommuniCare does not store your full credit card
              ...
              <List>
                <ListItem>
                  ...
                  <ListItemText
                    ...
                    secondary="To operate, maintain, and improve the features and functionality of CommuniCare"
                  />
                </ListItem>
                <ListItem>
                  <ListItemIcon>
              ...
              <List>
                ...
                <ListItem>
                  ...
                  <ListItemText
                    ...
                    secondary="If CommuniCare is involved in a merger, acquisition, or sale of all or a portion of its assets, your information may be transferred as part of that transaction. We will notify you via email and/or a prominent notice on our website of any change in ownership or uses of your information."
                  />
                </ListItem>
                <ListItem>
                  <ListItemIcon>
                ...
                <ListItem>
                  ...
                  <ListItemText
                    ...
                    secondary="We may disclose your information to protect the safety, rights, or property of CommuniCare, our users, or others, including to protect against fraud or other illegal activity."
                  />
                </ListItem>
              </List>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" paragraph sx={{ mt: 2 }}>
                ...
                privacy@CommuniCare.com. We will respond to your request within
                30 days.
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" paragraph>
                ...
                at privacy@CommuniCare.com. If we become aware that we have
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" paragraph>
                ...
                or applications that are not owned or controlled by CommuniCare.
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" paragraph sx={{ mt: 2 }}>
                ...
                privacy@CommuniCare.com or call us at 1-800-MENU-APP. We will
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Box sx={{ pl: 2, borderLeft: "4px solid #107C10", mb: 2 }}>
                <Typography variant="body1">
                  <strong>Email:</strong> privacy@CommuniCare.com
                  <br />
