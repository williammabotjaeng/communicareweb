    ...
    if (receiptAnalysisError) {
      setSnackbar({
        ...
        message: `Error processing receipt: ${
          receiptAnalysisError.response?.data?.error ||
          receiptAnalysisError.message
        }`,
        severity: "error",
      });
    }
        ...
        <Paper elevation={3} sx={{ p: 3, mb: 3 }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body2" sx={{ mb: 1 }}>
                ...
                {detailedResults.receipt_type || "Receipt"}
              </Typography>
              <Typography variant="body2" sx={{ mb: 1 }}>
                <strong>Document ID:</strong>{" "}
                {detailedResults.document_id || detailedResults.id}
              </Typography>
            </Grid>
            <Grid item xs={12} md={6}>
              {previewUrl && (
          ...
          >
            ...
            >
              ...
              <Typography variant="body2">
                $
                {typeof displayData.subtotal === "number"
            ...
            >
              ...
              <Typography variant="body1" sx={{ fontWeight: "bold" }}>
                <strong>
                  $
                  {typeof displayData.total === "number"
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" sx={{ mb: 4 }}>
            Upload receipts and invoices to automatically extract items, prices,
            and totals.
          </Typography>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={6}>
                <Typography variant="body1" sx={{ mb: 2 }}>
                  Our AI-powered receipt processing extracts key information
                  like merchant, date, items purchased, prices, and totals.
                  Works with receipts and invoices.
                </Typography>
