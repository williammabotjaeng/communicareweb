...
const PricingPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "No long-term contract is required. For monthly plans, you pay month-to-month and can cancel anytime. Annual plans are paid up front for the year and provide a 20% discount compared to monthly billing.",
    },
    {
      question: "How does the AI translation work?",
      answer:
        "Our AI translation is powered by Azure AI services and supports automatic menu translation for international customers. The Standard plan includes 5 languages, while the Premium plan supports 15+ languages with more advanced contextual translation capabilities.",
    },
    {
      question: "Do you offer custom solutions for large restaurant chains?",
      answer:
        "Yes, we offer custom enterprise solutions for restaurant chains with multiple locations. Our enterprise plans include dedicated support, custom branding, API access, and more. Please contact our sales team to discuss your specific requirements.",
    },
    {
      question: "What payment methods do you accept?",
      answer:
        "We accept all major credit cards, including Visa, Mastercard, American Express, and Discover. For annual enterprise plans, we can also accommodate invoicing and bank transfers.",
    },
    {
      question: "Is there a setup fee?",
      answer:
        "No, there are no setup fees for any of our plans. You only pay the advertised price for your chosen plan, and you can get started immediately after signing up.",
    },
  ];
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          premium: "Dedicated onboarding",
        },
        {
          name: "Training",
          free: "Documentation",
          standard: "Webinars",
          premium: "Custom training",
        },
      ],
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <Container maxWidth="lg">
          <Typography
            variant="h2"
            component="h1"
            sx={{ fontWeight: 700, mb: 2, color: theme.colors.text }}
          >
          ...
          >
            Choose the plan that helps your restaurant <strong>TIP</strong> into
      ...
      <Container
        maxWidth="lg"
        sx={{ mt: -4, mb: 8, position: "relative", zIndex: 2 }}
      >
        <Box
          sx={{
            display: "flex",
        ...
        >
          {pricingTiers.map((tier, index) => (
            <Paper
              ...
              sx={{
                ...
                "&:hover": {
                  transform: {
                    xs: "none",
                    md: tier.highlight ? "scale(1.07)" : "scale(1.02)",
                  },
            ...
            >
              ...
              <Typography
                variant="body2"
                sx={{ color: theme.colors.lightText, mb: 3, minHeight: 42 }}
              >
                {tier.description}
              </Typography>
              ...
              <Box sx={{ mb: 3 }}>
                <Box sx={{ display: "flex", alignItems: "flex-end", mb: 1 }}>
                  ...
                  <Typography
                    variant="body1"
                    component="span"
                    sx={{ ml: 1, mb: 0.5, color: theme.colors.lightText }}
                  >
                    /month
                  </Typography>
                </Box>
      ...
      <Box sx={{ bgcolor: "white", py: 8 }}>
        <Container maxWidth="lg">
          ...
          <Typography
            variant="body1"
            sx={{ mb: 6, textAlign: "center", color: theme.colors.lightText }}
          >
                  ...
                  <TableBody>
                    ...
                    {category.features.map((feature, featureIdx) => (
                      ...
                      >
                        ...
                        <TableCell
                          align="center"
                          sx={{ bgcolor: `${theme.colors.primary}05` }}
                        >
                          {feature.standard}
                        </TableCell>
                        <TableCell
                          align="center"
                          sx={{ bgcolor: `${theme.colors.secondary}05` }}
                        >
                          {feature.premium}
                        </TableCell>
                      </TableRow>
      ...
      <Box sx={{ py: 8, bgcolor: `${theme.colors.secondary}05` }}>
        <Container maxWidth="md" sx={{ textAlign: "center" }}>
          <LocalOffer
            sx={{ fontSize: 50, color: theme.colors.secondary, mb: 2 }}
          />
          <Typography
            variant="h3"
            component="h2"
          ...
          <Typography
            variant="body1"
            sx={{ mb: 4, color: theme.colors.lightText }}
          >
            CommuniCare offers custom solutions for restaurant chains and
            enterprises with specific requirements. Our team will work with you
            to create a tailored package that perfectly fits your needs.
          </Typography>
      ...
      <Box sx={{ py: 8 }}>
        <Container maxWidth="md">
          ...
          <Typography
            ...
            sx={{ mb: 6, textAlign: "center", color: theme.colors.lightText }}
          >
            Find answers to common questions about CommuniCare pricing
          </Typography>
          ...
          >
            <Typography
              variant="h6"
              sx={{ mb: 2, color: theme.colors.text, fontWeight: 600 }}
            >
              Still have questions?
            </Typography>
            <Typography
              variant="body1"
              sx={{ mb: 3, color: theme.colors.lightText }}
            >
      ...
      >
        <Container maxWidth="md">
          ...
          >
            Ready to <span style={{ color: theme.colors.accent }}>PROMPT</span>{" "}
            Your Digital Menu Journey?
          </Typography>
          <Typography variant="h6" component="p" sx={{ mb: 4, opacity: 0.9 }}>
            Join thousands of restaurants that have enhanced their dining
            experience with CommuniCare. Start your 14-day free trial of any
            plan today.
          </Typography>
