...
import MemberDashboardHeader from "@/components/member/Header";
        ...
        >
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" color="text.secondary">
              Welcome to your CommuniCare dashboard. Explore our AI-powered
              features below.
            </Typography>
          </Box>
              ...
              >
                <CardContent sx={{ flexGrow: 1 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Automatically scan and process invoices and receipts to
                    streamline receiving and accounting. Extract item prices,
                    quantities, taxes, and totals with our advanced AI.
                  </Typography>
                </CardContent>
              ...
              >
                <CardContent sx={{ flexGrow: 1 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    understand dishes better with detailed ingredient analysis,
                    nutritional information, and allergen detection.
                  </Typography>
                </CardContent>
                <CardActions sx={{ p: 2, pt: 0 }}>
                  <Button
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                <CardContent sx={{ flexGrow: 1 }}>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Comprehensive AI assistant that answers customer questions
                    about menu items, ingredients, or preparation methods.
                    Enhance customer experience with instant information.
                  </Typography>
                </CardContent>
                <CardActions sx={{ p: 2, pt: 0 }}>
                  <Button
