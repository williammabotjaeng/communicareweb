          ...
          >
            ...
            <Box sx={{ mb: 5 }}>
              <Typography variant="body1" paragraph>
                Welcome to CommuniCare. These Terms of Service ("Terms") govern
                your access to and use of our digital menu platform, including
                our website, mobile applications, and all services provided
                through them (collectively, the "Service"). By accessing or
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" paragraph>
                As a restaurant owner or manager using our Service, you are
                responsible for providing accurate and up-to-date information
                about your restaurant, including menu items, prices,
                ingredients, allergens, and any other relevant details. You
                agree not to misrepresent your restaurant or menu offerings.
              </Typography>
              <Typography variant="body1" paragraph>
                You understand that diners may rely on the information you
                provide through our Service to make dining decisions, including
                those related to food allergies and dietary restrictions. You
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" paragraph>
                ...
                functionality are owned by CommuniCare and are protected by
                international copyright, trademark, patent, trade secret, and
                other intellectual property or proprietary rights laws.
              </Typography>
              <Typography variant="body1" paragraph>
                By uploading or sharing content through our Service (such as
                restaurant photos, menu descriptions, or videos), you grant
                CommuniCare a non-exclusive, royalty-free, worldwide license to
                use, reproduce, modify, adapt, publish, translate, and
                distribute such content in connection with providing and
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <List>
                ...
                <ListItem>
                  ...
                  <ListItemText primary="To impersonate or attempt to impersonate CommuniCare, a CommuniCare employee, another user, or any other person or entity" />
                </ListItem>
                <ListItem>
                  <ListItemIcon>
                    <Cancel sx={{ color: "#d32f2f" }} />
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" paragraph>
                Some features of our Service require payment of fees. All fees
                are stated in US dollars and do not include taxes, which are
                your responsibility.
              </Typography>
              <Typography variant="body1" paragraph>
                You agree to provide accurate and complete billing information,
                including legal name, address, telephone number, and payment
                method details. You authorize us to charge your chosen payment
                method for all fees incurred.
              </Typography>
              <Typography variant="body1" paragraph>
                Subscription fees are billed in advance on a monthly or annual
                basis, depending on the subscription plan selected. Subscription
                periods begin on the date of your initial subscription purchase
                and renew automatically until terminated.
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" paragraph>
                ...
                CommuniCare, its directors, employees, partners, agents,
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography
                variant="body1"
                sx={{ pl: 2, borderLeft: "4px solid #107C10", mb: 2 }}
              >
                <strong>Email:</strong> legal@CommuniCare.com
                <br />
                <strong>Address:</strong> CommuniCare, Inc.
                <br />
                123 Digital Lane
                <br />
                Seattle, WA 98101
            ...
            <Box sx={{ textAlign: "center" }}>
              <Typography variant="body2" sx={{ color: "text.secondary" }}>
                By using CommuniCare's services, you acknowledge that you have
              ...
              >
                Thank you for choosing CommuniCare for your digital menu needs.
              </Typography>
            </Box>
          </Paper>
        </Box>
