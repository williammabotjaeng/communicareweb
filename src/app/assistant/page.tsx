...
const suggestedQuestions = [
  "What is CommuniCare?",
  "Who created CommuniCare?",
  "What problem does CommuniCare solve?",
  "How is CommuniCare different from other digital menu solutions?",
  "What are the main features of CommuniCare?",
  "Can customers see videos of food preparation?",
  "Does CommuniCare support multiple languages?",
  "Can CommuniCare handle customer reviews?",
  "Is CommuniCare mobile-friendly?",
  "What is video indexing in CommuniCare?",
  "Can CommuniCare process digital receipts?",
];
...
const QnAAssistant = () => {
  ...
  >([
    {
      type: "ai",
      text: "👋 Hi there! I'm your CommuniCare assistant. Ask me any questions about our menu, ingredients, dietary restrictions, or recommendations!",
    },
  ]);
    ...
    if (assistantResponse) {
      ...
      if (assistantResponse.is_default_answer) {
        setSnackbar({
          open: true,
          message:
            "I don't have specific information about that yet. I've provided a general response.",
          severity: "info",
        });
      }
  ...
  useEffect(() => {
    if (assistantError) {
      ...
      setSnackbar({
        open: true,
        message: `Error: ${
          assistantError.response?.data?.error || assistantError.message
        }`,
        severity: "error",
      });
    }
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" sx={{ mb: 4 }}>
            Ask any questions about our menu, ingredients, dietary options, or
          ...
          >
            ...
            <Box sx={{ flex: 1 }}>
              ...
              >
                ...
                >
                  <QuestionAnswer />
                  <Typography variant="h6">CommuniCare Assistant</Typography>
                </Box>
              ...
              >
                ...
                <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1, mb: 2 }}>
                  ...
                  <Chip
                    label="Specials"
                    onClick={() =>
                      handleSuggestedQuestion("What are today's specials?")
                    }
                  />
                  <Chip
                    label="Allergens"
                    onClick={() =>
                      handleSuggestedQuestion("What dishes contain nuts?")
                    }
                  />
                  <Chip
                    label="Desserts"
                    onClick={() =>
                      handleSuggestedQuestion("What desserts do you recommend?")
                    }
                  />
                </Box>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                  <Button
                    ...
                    size="small"
                    onClick={() =>
                      handleSuggestedQuestion("What's your signature dish?")
                    }
                    sx={{
                      justifyContent: "flex-start",
                      textTransform: "none",
                  ...
                  <Button
                    ...
                    onClick={() =>
                      handleSuggestedQuestion(
                        "What wine goes well with your steak?"
                      )
                    }
                    sx={{
                      justifyContent: "flex-start",
